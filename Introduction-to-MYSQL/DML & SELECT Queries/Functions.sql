...
select avg(discounted_price) from products where brand_tag = 'puma';
select min(discounted_price) from products where brand_tag = 'puma';
select max(discounted_price) from products where brand_tag = 'puma';
...
select avg(discounted_price) as 'avg',min(discounted_price) as 'min',max(discounted_price) as 'max' from products where brand_tag = 'puma';
...
select count(*) as 'Total Products' from products where brand_tag = 'nike';
...
# round | rating * rating count
select product_name, round(rating * rating_count) from products;