...
INSERT INTO gfg.users VALUES (2, 'user2', 'user1@example.com', 25, 'City1');
INSERT INTO gfg.users (username,user_id, email, age, city) VALUES ('user3', 23, 'user1@example.com', 25, 'City1');
